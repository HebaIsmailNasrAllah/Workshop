...
import com.example.workshopapp.databinding.ItemFavouriteBinding
import com.example.workshopapp.databinding.ItemNewsBinding

class FavouriteAddapter(var items:List<ArticlesItem>): RecyclerView.Adapter<FavouriteAddapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataBinding= DataBindingUtil.inflate<ItemFavouriteBinding>(
    ...
    class ViewHolder(val dataBinding: ItemFavouriteBinding): RecyclerView.ViewHolder(dataBinding.root)
}